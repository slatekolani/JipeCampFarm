        ...
        <AdminLayout title={slide ? 'Edit Slide' : 'New Slide'}>
            ...
            <div className="max-w-2xl">
                ...
                <form onSubmit={submit} className="bg-white border border-gray-200 rounded-2xl p-7 space-y-5">
                    ...
                    {/* Subtitle */}
                    <div>
                        <label className="block text-gray-600 text-xs uppercase tracking-wider mb-1.5">Subtitle</label>
                    ...
                    {/* Image Upload */}
                    <div>
                        <label className="block text-gray-600 text-xs uppercase tracking-wider mb-1.5">Hero Image</label>
                        {preview && (
                        ...
                        <div
                            ...
                            className="border-2 border-dashed border-gray-200 hover:border-[#d4a853]/50 rounded-xl p-6 text-center cursor-pointer transition-colors"
                        >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-gray-600 text-xs uppercase tracking-wider mb-1.5">CTA Button Text</label>
                            <input type="text" value={data.cta_text} onChange={e => setData('cta_text', e.target.value)} className={inputCls} />
                        </div>
                        <div>
                            <label className="block text-gray-600 text-xs uppercase tracking-wider mb-1.5">CTA URL</label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-3 pt-7">
                            ...
                            <label htmlFor="is_active" className="text-gray-600 text-sm">Active</label>
                        </div>
                    </div>
                    <div className="flex gap-3 pt-2">
                        ...
                        <a href="/admin/hero" className="px-5 py-3 border border-gray-200 hover:border-white/20 text-gray-600 hover:text-white text-sm rounded-xl transition-all text-center">Cancel</a>
                    </div>
                </form>
            </div>
        </AdminLayout>
