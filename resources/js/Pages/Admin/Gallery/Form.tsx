                ...
                <form onSubmit={submit} className="bg-[#071510] border border-white/8 rounded-2xl p-7 space-y-5">
                    ...
                    <div>
                        ...
                        <div onClick={() => fileRef.current?.click()} className="border-2 border-dashed border-white/10 hover:border-[#d4a853]/50 rounded-xl p-6 text-center cursor-pointer transition-colors">
                            ...
                            <p className="text-white/40 text-sm">{data.image ? data.image.name : 'Click to upload photo'}</p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select value={data.category} onChange={e => setData('category', e.target.value)} className="w-full bg-[#0d1f13] border border-white/10 text-white rounded-xl px-4 py-3 text-sm outline-none">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <label htmlFor="active" className="text-white/70 text-sm">Active (visible on site)</label>
                    </div>
                    <div className="flex gap-3 pt-2">
                        ...
                        <a href="/admin/gallery" className="px-5 py-3 border border-white/10 text-white/50 text-sm rounded-xl text-center">Cancel</a>
                    </div>
                </form>
            </div>
        </AdminLayout>
