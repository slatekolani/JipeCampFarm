        ...
        <AdminLayout title={activity ? 'Edit Activity' : 'New Activity'}>
            ...
            <div className="max-w-2xl">
                ...
                <form onSubmit={submit} className="bg-white border border-gray-200 rounded-2xl p-7 space-y-5">
                    ...
                    {/* Image Upload */}
                    <div>
                        <label className="block text-gray-600 text-xs uppercase tracking-wider mb-1.5">Activity Image</label>
                        {preview && (
                    ...
                    <div>
                        <label className="block text-gray-600 text-xs uppercase tracking-wider mb-1.5">Full Details</label>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            <label className="block text-gray-600 text-xs uppercase tracking-wider mb-1.5">Difficulty</label>
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <a href="/admin/activities" className="px-5 py-3 border border-gray-200 text-gray-600 hover:text-white text-sm rounded-xl text-center">Cancel</a>
                    </div>
                </form>
            </div>
        </AdminLayout>
